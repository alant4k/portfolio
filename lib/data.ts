...
export const experiencesData = [
  {
    ...
    location: "Trybe",
    description:
      "Com 1500 horas de aula em um ano, aprimorei fundamentos sobre aplicações web com HTML, CSS, JavaScript e React. No back-end, criei projetos com Node.js e Express, e trabalhei com bancos de dados relacionais e não relacionais. Além das habilidades técnicas, também desenvolvi soft skills importantes.",
